			...
			<div className={styles.container}>
				<main className={styles.section_1}>
					<span className={styles.heading}>
						We find matching jobs for your CV on your selected job
						boards(Indeed,LinkedIn etc.) <br />
						We also Help you Tailor Your CV to get more Interviews. <br />
						Use our tracking enabled CV service to keep track of your job
						search. <br />
						Join our two weeks trial work/Internship offer to help us match you
						for the right jobs in our Network.
					</span>
					<div className={styles.upload_box}>
						...
						<button className={styles.upload_btn}>Upload CV</button>
						<div className={styles.upload_drag_drop}>
							<div className={styles.upload_animated_circle}></div>
							<Image
								src={uploadBtnImg}
								alt="upload btn image"
								className={styles.upload_btn_img}
							/>
						</div>
					</div>
				</main>
				...
				<section className={styles.section_2}>
					...
					<span className={styles.section_2_sub_title}>
						Our software platform keeps track of jobs posted on the popular job{" "}
						<br />
						boards. We match your CV automatically and send you matching Job
						<br />
						URLs. Our team maintain extensive list of recruiters and advise you
						send <br />
						your CV to them. It can really save lot of time and increase your
						chances
					...
					<div className={styles.flex_box}>
						<div className={styles.box}>
							...
							<span className={styles.box_step_content}>
								Get Free CV Review and Rating Score from our Team.(PDF or use
								DOCX for tracking). We share best job winning CV templates with
								you.
							</span>
						</div>
						<div className={styles.box}>
							...
							<span className={styles.box_step_heading}>
								Select Your Target Job Sector
							</span>
							<span className={styles.box_step_content}>
								We match your CV and start sending you matching jobs and
								Recruiters Information. You can add tracking to your CV and Get
								Notified when recruiters open it.
							</span>
						</div>
						<div className={styles.box}>
							...
							<span className={styles.box_step_content}>
								Recruiter access your cv on Job Board you can get free tracking
				...
				<section className={styles.section_3}>
					<span className={styles.section_3_title}>
						We help in other ways with new <br /> tools and services to get you
						that
						<br />
						job
					</span>
					...
					<div className={styles.flex_box}>
						<div className={styles.box}>
							...
							<span className={styles.box_service_content}>
								With our CV-writing services, you’ll get: 1:1 support from your
				...
				<section className={styles.section_4}>
					...
					<form className={styles.form}>
						...
						<textarea
							className={styles.form_input_2}
							placeholder="Type your message here..."
						></textarea>
						<input
							className={styles.form_send_message_btn}
							type="submit"
							value="Send Message"
						/>
					</form>
