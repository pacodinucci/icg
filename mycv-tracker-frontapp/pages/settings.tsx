...
import { sendGetUserProfileSettings, sendUpdateProfileSettings } from "../apis/mycvtracker";
  ...
  useEffect(() => {
    const makeRequest = async () => {
      try {
        ...
        setDetails({ email: data.emailAddress, firstName: data.firstName, lastName: data.lastName });
      } catch (e: any) {
